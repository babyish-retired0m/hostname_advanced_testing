...
<<<<<<< Updated upstream
		...
		ip_addresses_block_AS_44600 = File.open_as_list(parent_dir + "/ip_addresses_block_provider/AS-44600_gigatrans.ua.txt")
=======
...
<<<<<<< Updated upstream
		...
		elif ip_address.check_ip_in_networks(self.ip_address_pub, ip_addresses_block_AS_44600):
			nameservers.append("172.253.1.129")
			#nameservers.extend(['172.253.1.130', '172.253.1.131', '172.253.1.132', '172.253.1.133', '172.253.206.33', '172.253.206.34', '172.253.206.35', '172.253.206.36', '172.253.206.37', '172.253.255.33', '172.253.255.34', '172.253.255.35', '172.253.255.36', '172.253.255.37'])
=======
